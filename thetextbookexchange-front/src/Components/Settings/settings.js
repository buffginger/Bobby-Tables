                ...
                <div className="container-fluid sidenavWrapper p-0">
                    ...
                    <div className="jumbotron jumbotron-fluid">
                        <div className="container" >
                            ...
                            <p className="lead" style={{"padding-left" : 15}}> Double Check All Changes Before Continuing</p>
                                <hr/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br/>Current Number <input type="text" class="input-large bfh-phone" data-country="US" id="currentNum"placeholder="XXX-XXX-XXXX"/>
                                        <br/>New Number <input type="text" class="input-large bfh-phone" data-country="US" id="newNum"placeholder="XXX-XXX-XXXX"/>
                                        <br/>Confirm Number <input type="text" class="input-large bfh-phone" data-country="US" id="confirmNum"placeholder="XXX-XXX-XXXX"/>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="confirmPW" placeholder="Confirm New Password"/>
                                    </div>

                                    <div class="form-group">
                                        <b><label for="userEmail">Change Email</label></b>
                                        <input type="email" class="form-control" id="" aria-describedby="emailHelp" placeholder="Enter new email"/>

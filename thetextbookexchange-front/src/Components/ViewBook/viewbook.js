                        ...
                        <div className="jumbotron jumbotron-fluid">
                            <div className="container">
                                ...
                                <div id="carousel" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img class="d-block w-100" style={{"width":300, "height":600}} src="http://assets.s4rb-systems.co.uk/images/tumbeasts/sign-2.png" alt="Slide One"/>
                                        </div>

                                        <div class="carousel-item">
                                            <img class="d-block w-100" style={{"width":300, "height":600}} src="https://ih0.redbubble.net/image.55998815.1905/mwo%2C187x204%2Cipad_2_snap-pad%2C210x230%2Cf8f8f8.lite-1.jpg" alt="Slide Two"/>
                                        </div>

                                        <div class="carousel-item">
                                            <img class="d-block w-100" style={{"width":300, "height":600}} src="http://assets.s4rb-systems.co.uk/images/tumbeasts/run-2.png" alt="Third slide"/>
                                        </div>
                                    </div>
                                ...
                                <div style={{"padding-left": 15}} div class="book-img">
                                    ...
                                    <p>Hello All! I am selling the tumbeasts book - as the title specifies. The tumbeasts within vary in emotions and mental stability. They are collected
                                       from all over the internet and therefore are very unique and also compounded into a special edition, just for you! The book is 5$. What a bargain.
                                    </p> 
                                    ...
                                    <p> These tumbeasts are in great condition, spare the second which is a bit pixelated. </p>
